...
public class NotificationDeleteReceiver extends BroadcastReceiver {
    ...
    static final String EXTRA_GROUP = "NotificationDeleteReceiver.GROUP";
    static final String EXTRA_NOTIFICATION_ID = "NotificationDeleteReceiver.NOTIFICATION_ID";
    static final String EXTRA_PENDING_INTENT_TO_START = "NotificationDeleteReceiver.PENDING_INTENT";
