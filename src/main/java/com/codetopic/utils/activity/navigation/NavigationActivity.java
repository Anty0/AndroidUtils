...
import com.codetopic.utils.activity.fragment.BaseFragmentActivity;
...
public abstract class NavigationActivity extends BaseFragmentActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.codetopic.utils.R.layout.navigation_main);
        Toolbar toolbar = (Toolbar) findViewById(com.codetopic.utils.R.id.toolbar);
        drawer = (DrawerLayout) findViewById(com.codetopic.utils.R.id.drawer_layout);
        navigationView = (NavigationView) findViewById(com.codetopic.utils.R.id.nav_view);
        //noinspection ConstantConditions
        textViewAppTitle = (TextView) navigationView.getHeaderView(0)
                .findViewById(com.codetopic.utils.R.id.textViewAppTitle);

        //noinspection ConstantConditions
        ((ImageView) navigationView.getHeaderView(0).findViewById(com.codetopic.utils.R.id.imageViewAppIcon))
        ...
        setHeaderBackgroundColor(Utils.makeColorDarker(Utils.getColorFromAttr(this,
                com.codetopic.utils.R.attr.colorPrimaryDark, Color.rgb(0, 0, 0)), 0.8f));
        textViewAppTitle.setText(getTitle());
        setSupportActionBar(toolbar);

        ActionBarDrawerToggle toggle = new ActionBarDrawerToggle(this, drawer, toolbar,
                com.codetopic.utils.R.string.navigation_drawer_open, com.codetopic.utils.R.string.navigation_drawer_close);
    ...
    public void setHeaderBackground(Drawable drawable) {
        ...
        navigationView.getHeaderView(0).findViewById(com.codetopic.utils.R.id.navigationHeader)
    ...
    protected void onBeforeReplaceFragment(FragmentTransaction ft, Fragment fragment) {
        ft.setCustomAnimations(com.codetopic.utils.R.anim.abc_fade_in, com.codetopic.utils.R.anim.abc_fade_out);
    }
}
