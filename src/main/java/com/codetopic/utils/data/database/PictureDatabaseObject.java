...
import com.codetopic.utils.callback.CallbackUtils;
import com.codetopic.utils.data.database.holder.BitmapDatabaseObject;
import com.codetopic.utils.data.database.holder.BitmapHolder;
import com.codetopic.utils.data.getter.DatabaseDaoGetter;
import com.codetopic.utils.thread.job.database.DatabaseWork;
import com.codetopic.utils.thread.job.database.DbJob;
...
public abstract class PictureDatabaseObject<BDO extends BitmapDatabaseObject,
    ...
    public PictureDatabaseObject(DatabaseDaoGetter<BDO, Long> bitmapDatabaseObjectDaoGetter,
