...
import com.codetopic.utils.animation.ViewVisibilityAnimator;
import com.codetopic.utils.view.holder.ViewHolder;
...
public abstract class LoadingVHImpl extends LoadingVH {
    ...
    protected static class LoadingWrappingInfo extends ViewHolder.WrappingInfo {
