...
public class ViewHolderModule<VH extends ViewHolder> extends SimpleActivityCallBackModule {
    ...
    @Override
    public void onSetContentView(@LayoutRes final int layoutResID, @NotNull SetContentViewCallBack callBack) {
    ...
    @Override
    public void onSetContentView(@NotNull final View view, @NotNull SetContentViewCallBack callBack) {
        final ViewHolder.ViewUpdater updater = mHolder.getViewUpdater();
        if (!updater.requiresBaseLayout()) {
            throw new IllegalStateException("Can't create contentView for ViewHolder without base layout");
            //callBack.pass();
    ...
    @Override
    public void onSetContentView(@NotNull final View view,
                                 @NotNull final ViewGroup.LayoutParams params,
                                 @NotNull SetContentViewCallBack callBack) {
