...
public class Connectivity {
    ...
    /**
     * Check if there is requested connectivity
     *
     * @param context Any context
     * @return true if there is requested connectivity available
     */
    public static boolean isNetworkAvailable(Context context, boolean useMobileNetwork) {
        return !isDozing(context) && (useMobileNetwork ? isConnected(context) : isConnectedWifi(context));
    }
     ...
     *
     * @param context Any context
     * @return true if there is any connectivity
     */
     ...
     *
     * @param context Any context
     * @return true if there is any connectivity to a Wifi network
     */
     ...
     *
     * @param context Any context
     * @return true if there is any connectivity to a mobile network
     */
