...
import cz.codetopic.utils.activity.navigation.NavigationFragment;
...
public class ModulesDashboardFragment extends NavigationFragment {
    ...
    public static final String ACTION_NOTIFY_UPDATE_ITEMS = "cz.codetopic.utils.module.dashboard.ModulesDashboardFragment";
    ...
    public View onCreateContentView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        mRecyclerManager = RecyclerInflater.inflate(getContext(), container, false)
                .setLayoutInflater(inflater).useSwipeRefresh(false).inflate();
