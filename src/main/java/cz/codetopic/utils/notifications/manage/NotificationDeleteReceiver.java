...
public class NotificationDeleteReceiver extends BroadcastReceiver {
    ...
    static final String EXTRA_GROUP = "cz.codetopic.utils.notifications.manage.NotificationDeleteReceiver.GROUP";
    static final String EXTRA_NOTIFICATION_ID = "cz.codetopic.utils.notifications.manage.NotificationDeleteReceiver.NOTIFICATION_ID";
    static final String EXTRA_PENDING_INTENT_TO_START = "cz.codetopic.utils.notifications.manage.NotificationDeleteReceiver.PENDING_INTENT";
