package cz.codetopic.utils.notifications;
...
import cz.codetopic.utils.notifications.manage.Group;
...
public class PostNotificationCanceler extends BroadcastReceiver {
    ...
    private static final String ACTION_ADD_NAME = "cz.codetopic.utils.notifications.PostNotificationCanceler.";
    private static final String EXTRA_GROUP = "cz.codetopic.utils.notifications.PostNotificationCanceler.GROUP";
    private static final String EXTRA_NOTIFICATION_ID = "cz.codetopic.utils.notifications.PostNotificationCanceler.NOTIFICATION_ID";
